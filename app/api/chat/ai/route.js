    ...
    const followUpPrompt = [
      {
        role: "system",
        content:
          "You are a helpful assistant that suggests friendly and engaging follow-up questions or suggestions based on the conversation.",
      },
      ...messagesForAI,
      mainAIResponse,
      {
        role: "user",
        content:
          "Please provide a friendly follow-up question or suggestion to keep the conversation going.",
      },
    ];
